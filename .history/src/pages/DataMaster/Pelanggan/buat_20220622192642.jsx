...
const BuatPelanggan = () => {
  ...
  const addKota = (newKota) => setKota(state => [newKota, ...state])
  const addKecamatan = (newKecamatan) => setKecamatan(state => [newKecamatan, ...state])
  const addKelurahan = (newKelurahan) => setKelurahan(state => [newKelurahan, ...state])
  const addKode_pos = (newKode_pos) => setKode_pos(state => [newKode_pos, ...state])
                          ...
                          <>
                            ...
                            <TableCell>
                              <TextField
                                ...
                                onChange={(e) => addKelurahan(e.target.value)}
                              />
                            </TableCell>
                            <TableCell>
                              <TextField
                                ...
                                onChange={(e) => addKecamatan(e.target.value)}
                              />
                            </TableCell>
                            <TableCell>
                              <TextField
                                ...
                                onChange={(e) => addKota(e.target.value)}
                              />
                            </TableCell>
                            <TableCell>
                              <TextField
                                ...
                                onChange={(e) => addKode_pos(e.target.value)}
                              />
                            </TableCell>
                            <TableCell>
