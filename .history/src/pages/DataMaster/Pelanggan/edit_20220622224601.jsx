...
const EditPelanggan = () => {
  ...
  console.log(data[0].business_entity === "PT");
  console.log(data[0].business_entity === "CV");
        ...
        <form className="form-input shadow-lg p-3 mb-5 bg-body rounded">
          ...
          <div className="row mb-3">
            ...
            <div className="col-sm-10">
              ...
              >
                <option selected={false}>Pilih Badan Usaha</option>
                <option value="PT" selected={data[0].business_entity === "PT"}>
                  PT
                </option>
                <option value="CV" selected={data[0].business_entity === "CV"}>
                  CV
                </option>
                <option value="Lainnya" selected={data[0].business_entity === "Lainnya.."}>
                  Lainnya..
                </option>
              </select>
            </div>
