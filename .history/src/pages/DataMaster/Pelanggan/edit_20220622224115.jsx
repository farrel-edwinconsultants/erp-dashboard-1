          ...
          <div className="row mb-3">
            ...
            <div className="col-sm-10">
              ...
              >
                ...
                <option value="PT" defaultSelected={data.bussiness_entity === "PT"}>
                  PT
                </option>
                <option value="CV" defaultSelected={data.bussiness_entity === "CV"}>
                  CV
                </option>
                <option value="Lainnya" defaultSelected={data.bussiness_entity === "Lainnya.."}>
                  Lainnya..
                </option>
              </select>
            </div>
