          ...
          <div className="row mb-3">
            ...
            <div className="col-sm-10">
              ...
              >
                ...
                <option value="PT" selected={data[0].bussiness_entity === "PT"}>
                  PT
                </option>
                <option value="CV" selected={data[0].bussiness_entity === "CV"}>
                  CV
                </option>
                <option value="Lainnya" selected={data[0].bussiness_entity === "Lainnya.."}>
                  Lainnya..
                </option>
              </select>
            </div>
