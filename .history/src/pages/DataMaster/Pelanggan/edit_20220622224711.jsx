          ...
          <div className="row mb-3">
            ...
            <div className="col-sm-10">
              ...
              >
                ...
                <option value="PT" selected={data.business_entity === "PT"}>
                  PT
                </option>
                <option value="CV" selected={data.business_entity === "CV"}>
                  CV
                </option>
                <option value="Lainnya" selected={data.business_entity === "Lainnya.."}>
                  Lainnya..
                </option>
              </select>
            </div>
