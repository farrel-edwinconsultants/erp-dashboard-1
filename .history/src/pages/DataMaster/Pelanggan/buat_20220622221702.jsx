...
const BuatPelanggan = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    data.map((address) => {
      ...
      userData.append("kota[]", address.kota);
      userData.append("kecamatan[]", address.kecamatan);
      userData.append("kelurahan[]", address.kelurahan);
      userData.append("kode_pos[]", address.kode_pos);
    });
