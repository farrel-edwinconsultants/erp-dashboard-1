                ...
                <fieldset className="row mb-3">
                    ...
                    <div className="col-sm-10">
                        <div className="form-check">
                            <input onChange={e => setStatus(e.target.value) === 'option1'} className="form-check-input" type="radio" name="gridRadios" id="gridRadios1" value="option1" checked/>
                            <label className="form-check-label" htmlFor="gridRadios1">
                                Aktif
                            </label>
                        </div>
                        <div className="form-check">
                            <input onChange={e => setStatus(e.target.value) !== 'option1'} className="form-check-input" type="radio" name="gridRadios" id="gridRadios2" value="option2"/>
