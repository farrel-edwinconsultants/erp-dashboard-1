...
export const detailGrade = () => {
  return (
    <>
    <form NameName="form-input shadow-lg p-3 mb-5 bg-body rounded">
    <div NameName="text-title text-start mb-4">
        <h3 NameName="title fw-bold">Grade</h3>
    </div>
